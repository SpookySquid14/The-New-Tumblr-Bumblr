...
declare namespace dev.ftb.mods.ftblibrary.ui {
    class CursorType extends Internal.Enum<dev.ftb.mods.ftblibrary.ui.CursorType> implements Internal.CursorTypeAccess {
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        getClass(): typeof any;
        static values(): dev.ftb.mods.ftblibrary.ui.CursorType[];
        static set(type: dev.ftb.mods.ftblibrary.ui.CursorType_): void;
        getDeclaringClass(): typeof dev.ftb.mods.ftblibrary.ui.CursorType;
        minecraft_cursor$getCursor(): number;
        toString(): string;
        notifyAll(): void;
        static valueOf(name: string): dev.ftb.mods.ftblibrary.ui.CursorType;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<dev.ftb.mods.ftblibrary.ui.CursorType>>;
        notify(): void;
        wait(arg0: number, arg1: number): void;
        ...
        wait(): void;
        wait(arg0: number): void;
        compareTo(arg0: dev.ftb.mods.ftblibrary.ui.CursorType_): number;
        "compareTo(java.lang.Object)"(arg0: any): number;
        equals(arg0: any): boolean;
        "compareTo(dev.ftb.mods.ftblibrary.ui.CursorType)"(arg0: dev.ftb.mods.ftblibrary.ui.CursorType_): number;
        minecraft_cursor$getShape(): number;
        get class(): typeof any
        get declaringClass(): typeof dev.ftb.mods.ftblibrary.ui.CursorType
        static readonly HAND: (dev.ftb.mods.ftblibrary.ui.CursorType) & (dev.ftb.mods.ftblibrary.ui.CursorType);
        static readonly ARROW: (dev.ftb.mods.ftblibrary.ui.CursorType) & (dev.ftb.mods.ftblibrary.ui.CursorType);
        static readonly HRESIZE: (dev.ftb.mods.ftblibrary.ui.CursorType) & (dev.ftb.mods.ftblibrary.ui.CursorType);
        static readonly IBEAM: (dev.ftb.mods.ftblibrary.ui.CursorType) & (dev.ftb.mods.ftblibrary.ui.CursorType);
        static readonly VRESIZE: (dev.ftb.mods.ftblibrary.ui.CursorType) & (dev.ftb.mods.ftblibrary.ui.CursorType);
        static readonly CROSSHAIR: (dev.ftb.mods.ftblibrary.ui.CursorType) & (dev.ftb.mods.ftblibrary.ui.CursorType);
    }
...
declare namespace com.craisinlord.integrated_api.mixins.structures {
    interface SinglePoolElementAccessor {
        ...
        abstract integratedapi_getProcessors(): Internal.Holder<Internal.StructureProcessorList>;
        abstract integratedapi_getTemplate(): Internal.Either<ResourceLocation, Internal.StructureTemplate>;
    }
    type SinglePoolElementAccessor_ = SinglePoolElementAccessor;
}
declare namespace Internal {
    interface RegistryEntryAPI <V> extends Internal.Wrapped<V> {
    ...
    type RegistryEntryAPI_<V> = RegistryEntryAPI<V>;
    interface Function8 <T1, T2, T3, T4, T5, T6, T7, T8, R> {
        curry5(): Internal.Function5<T1, T2, T3, T4, T5, com.mojang.datafixers.util.Function3<T6, T7, T8, R>>;
        ...
        curry3(): com.mojang.datafixers.util.Function3<T1, T2, T3, Internal.Function5<T4, T5, T6, T7, T8, R>>;
    ...
    interface Function9 <T1, T2, T3, T4, T5, T6, T7, T8, T9, R> {
        ...
        curry3(): com.mojang.datafixers.util.Function3<T1, T2, T3, Internal.Function6<T4, T5, T6, T7, T8, T9, R>>;
        ...
        curry6(): Internal.Function6<T1, T2, T3, T4, T5, T6, com.mojang.datafixers.util.Function3<T7, T8, T9, R>>;
    ...
    interface Function7 <T1, T2, T3, T4, T5, T6, T7, R> {
        ...
        curry4(): Internal.Function4<T1, T2, T3, T4, com.mojang.datafixers.util.Function3<T5, T6, T7, R>>;
        curry3(): com.mojang.datafixers.util.Function3<T1, T2, T3, Internal.Function4<T4, T5, T6, T7, R>>;
    ...
    interface IPigmentTank extends Internal.IChemicalTank<Internal.Pigment, Internal.PigmentStack>, Internal.IEmptyPigmentProvider {
        ...
        insert(arg0: Internal.PigmentStack_, arg1: mekanism.api.Action_, arg2: Internal.AutomationType_): Internal.PigmentStack;
        extract(arg0: number, arg1: mekanism.api.Action_, arg2: Internal.AutomationType_): Internal.PigmentStack;
    ...
    abstract class CommandSenderAPI <S> extends Internal.AbstractWrapped<S> {
        getIfNotNullOrDefault<V>(arg0: Internal.Function_<S, V>, arg1: Internal.Supplier_<V>): V;
        getClass(): typeof any;
        "wrapIfNotNullOrDefault(java.util.function.Function,java.util.function.Function,java.lang.Object)"<V, R>(arg0: Internal.Function_<S, V>, arg1: Internal.Function_<V, R>, arg2: R): R;
        abstract getEntity(): Internal.EntityAPI<any, any>;
        getIfNotNull<V>(arg0: Internal.Function_<S, V>): V;
        "wrapIfNotNullOrDefault(java.util.function.Function,java.util.function.Function,java.util.function.Supplier)"<V, R>(arg0: Internal.Function_<S, V>, arg1: Internal.Function_<V, R>, arg2: Internal.Supplier_<R>): R;
        getWrapped(): S;
        "getIfNotNullOrDefault(java.util.function.Function,java.lang.Object)"<V>(arg0: Internal.Function_<S, V>, arg1: V): V;
        unwrap<U>(): U;
        notNull(): boolean;
        notify(): void;
        getWrappedClass(): S;
        wait(arg0: number, arg1: number): void;
        supplyIfNull<V>(arg0: Internal.Function_<S, V>, arg1: Internal.Supplier_<V>): V;
        abstract getName(): string;
        wrapIfNotNullOrDefault<V, R>(arg0: Internal.Function_<S, V>, arg1: Internal.Function_<V, R>, arg2: Internal.Supplier_<R>): R;
        getServer(): Internal.MinecraftServerAPI<any>;
        getIfNotNullOrDefault<V>(arg0: Internal.Function_<S, V>, arg1: V): V;
        toString(): string;
        isNullGetter(arg0: Internal.Function_<S, any>): boolean;
        notifyAll(): void;
        abstract getWorld(): Internal.WorldAPI<any>;
        notNullGetter(arg0: Internal.Function_<S, any>): boolean;
        hashCode(): number;
        wrapIfNotNull<V, R>(arg0: Internal.Function_<S, V>, arg1: Internal.Function_<V, R>): R;
        wrapIfNotNullOrDefault<V, R>(arg0: Internal.Function_<S, V>, arg1: Internal.Function_<V, R>, arg2: R): R;
        wait(): void;
        isNull(): boolean;
        wait(arg0: number): void;
        abstract sendMessage(arg0: Internal.TextAPI_<any>): void;
        "getIfNotNullOrDefault(java.util.function.Function,java.util.function.Supplier)"<V>(arg0: Internal.Function_<S, V>, arg1: Internal.Supplier_<V>): V;
        equals(arg0: any): boolean;
        get class(): typeof any
        get entity(): Internal.EntityAPI<any, any>
        get wrapped(): S
        get wrappedClass(): S
        get name(): string
        get server(): Internal.MinecraftServerAPI<any>
        get world(): Internal.WorldAPI<any>
        get "null"(): boolean
    }
    type CommandSenderAPI_<S> = CommandSenderAPI<S>;
    class WraithingFleshStewItem extends Internal.JNEDConsumableItem {
    ...
    type WraithingFleshStewItem_ = WraithingFleshStewItem;
    ...
    class StructureSpawnModifier implements Internal.StructureModifier {
        constructor(arg0: Internal.SpawnModifier_)
        getClass(): typeof any;
        ...
        toString(): string;
        getSpawnModifier(): Internal.SpawnModifier;
        notifyAll(): void;
        ...
        wait(arg0: number): void;
        equals(arg0: any): boolean;
        static access$getSERIALIZER$cp(): Internal.RegistryObject<any>;
        get class(): typeof any
        get spawnModifier(): Internal.SpawnModifier
        static readonly Companion: (Internal.StructureSpawnModifier$Companion) & (Internal.StructureSpawnModifier$Companion);
    }
    type StructureSpawnModifier_ = StructureSpawnModifier;
    class RitualContext {
        constructor()
        getClass(): typeof any;
        hashCode(): number;
    ...
    class BrewingStandBlockEntity extends Internal.BaseContainerBlockEntity implements Internal.InventoryChangeTracker, Internal.WorldlyContainer {
        ...
        */
        ...
        handler$nmb000$amendments$refreshModel(tag: Internal.CompoundTag_, ci: Internal.CallbackInfo_): void;
    ...
    abstract class IERecipeSerializer <R extends Internal.Recipe<any>> implements Internal.RecipeSerializer<R> {
        constructor()
        getClass(): typeof any;
        ...
        toString(): string;
        abstract readFromJson(arg0: ResourceLocation_, arg1: com.google.gson.JsonObject_, arg2: Internal.ICondition$IContext_): R;
        notifyAll(): void;
    ...
    type IERecipeSerializer_<R extends Internal.Recipe<any>> = IERecipeSerializer<R>;
    ...
    abstract class AbstractWaypointRenderContext {
        constructor()
        getClass(): typeof any;
        hashCode(): number;
        toString(): string;
    ...
    type AbstractWaypointRenderContext_ = AbstractWaypointRenderContext;
    ...
    class Raid {
        ...
        wait(): void;
        stop(): void;
        handler$kkj000$raidsenhanced$spawnGroup(arg0: BlockPos_, arg1: Internal.CallbackInfo_): void;
        wait(arg0: number): void;
    ...
    type Melee_ = Melee;
    class ColorCache {
        constructor(arg0: Internal.Vector4_)
        static "of(mods.thecomputerizer.theimpossiblelibrary.api.shapes.vectors.Vector4,float)"(arg0: Internal.Vector4_, arg1: number): Internal.ColorCache;
        static "of(float,float,float)"(arg0: number, arg1: number, arg2: number): Internal.ColorCache;
        static grayscale(arg0: number, arg1: number): Internal.ColorCache;
        getVFWithAlpha(arg0: number): Internal.Vector4;
        b(): number;
        static "grayscale(float)"(arg0: number): Internal.ColorCache;
        notify(): void;
        static grayscale(arg0: number, arg1: number): Internal.ColorCache;
        "getIntWithAlpha(float)"(arg0: number): number;
        getIntWithAlpha(arg0: number): number;
        static of(arg0: number, arg1: number, arg2: number, arg3: number): Internal.ColorCache;
        static "of(int,int,int,float)"(arg0: number, arg1: number, arg2: number, arg3: number): Internal.ColorCache;
        "getVIWithAlpha(int)"(arg0: number): Internal.Vector4;
        static "of(mods.thecomputerizer.theimpossiblelibrary.api.shapes.vectors.Vector3)"(arg0: Internal.Vector3_): Internal.ColorCache;
        static "of(float,float,float,float)"(arg0: number, arg1: number, arg2: number, arg3: number): Internal.ColorCache;
        static "of(mods.thecomputerizer.theimpossiblelibrary.api.shapes.vectors.Vector4)"(arg0: Internal.Vector4_): Internal.ColorCache;
        getIntWithAlpha(arg0: number): number;
        getVIWithAlpha(arg0: number): Internal.Vector4;
        static of(arg0: Internal.Vector3_): Internal.ColorCache;
        "getVIWithAlpha(float)"(arg0: number): Internal.Vector4;
        getColorI(): number;
        static "of(mods.thecomputerizer.theimpossiblelibrary.api.shapes.vectors.Vector3,float)"(arg0: Internal.Vector3_, arg1: number): Internal.ColorCache;
        static of(arg0: Internal.Vector3_, arg1: number): Internal.ColorCache;
        static grayscale(arg0: number): Internal.ColorCache;
        wait(): void;
        getVFWithAlpha(arg0: number): Internal.Vector4;
        r(): number;
        "withAlpha(float)"(arg0: number): this;
        static ofI(arg0: Internal.Vector4_): Internal.ColorCache;
        getClass(): typeof any;
        static of(arg0: Internal.Vector4_): Internal.ColorCache;
        static "grayscale(int,int)"(arg0: number, arg1: number): Internal.ColorCache;
        withAlpha(arg0: number): this;
        static of(arg0: number, arg1: number, arg2: number, arg3: number): Internal.ColorCache;
        a(): number;
        getColorVF(): Internal.Vector4;
        wait(arg0: number, arg1: number): void;
        static "of(int,int,int)"(arg0: number, arg1: number, arg2: number): Internal.ColorCache;
        static "of(int,int,int,int)"(arg0: number, arg1: number, arg2: number, arg3: number): Internal.ColorCache;
        static of(arg0: number, arg1: number, arg2: number, arg3: number): Internal.ColorCache;
        static grayscale(arg0: Internal.Vector2_): Internal.ColorCache;
        getVIWithAlpha(arg0: number): Internal.Vector4;
        static grayscale(arg0: number): Internal.ColorCache;
        toString(): string;
        "getVFWithAlpha(int)"(arg0: number): Internal.Vector4;
        static "grayscale(float,float)"(arg0: number, arg1: number): Internal.ColorCache;
        "withAlpha(int)"(arg0: number): this;
        "getVFWithAlpha(float)"(arg0: number): Internal.Vector4;
        notifyAll(): void;
        static "grayscale(int)"(arg0: number): Internal.ColorCache;
        static of(arg0: Internal.Vector4_, arg1: number): Internal.ColorCache;
        static of(arg0: number, arg1: number, arg2: number): Internal.ColorCache;
        withAlpha(arg0: number): this;
        g(): number;
        hashCode(): number;
        static of(arg0: number, arg1: number, arg2: number): Internal.ColorCache;
        getColorVI(): Internal.Vector4;
        wait(arg0: number): void;
        equals(arg0: any): boolean;
        "getIntWithAlpha(int)"(arg0: number): number;
        static "grayscale(mods.thecomputerizer.theimpossiblelibrary.api.shapes.vectors.Vector2)"(arg0: Internal.Vector2_): Internal.ColorCache;
        get colorI(): number
        get class(): typeof any
        get colorVF(): Internal.Vector4
        get colorVI(): Internal.Vector4
    }
    type ColorCache_ = ColorCache;
...
declare namespace de.teamlapen.werewolves.api.entities.werewolf {
    class TransformType extends Internal.Enum<de.teamlapen.werewolves.api.entities.werewolf.TransformType> {
        static valueOf<T extends Internal.Enum<T>>(arg0: T, arg1: string): T;
        getClass(): typeof any;
        getDeclaringClass(): typeof de.teamlapen.werewolves.api.entities.werewolf.TransformType;
        toString(): string;
        compareTo(arg0: de.teamlapen.werewolves.api.entities.werewolf.TransformType_): number;
        notifyAll(): void;
        notify(): void;
        static values(): de.teamlapen.werewolves.api.entities.werewolf.TransformType[];
        wait(arg0: number, arg1: number): void;
        compareTo(arg0: any): number;
        name(): string;
        hashCode(): number;
        describeConstable(): Internal.Optional<Internal.Enum$EnumDesc<de.teamlapen.werewolves.api.entities.werewolf.TransformType>>;
        "compareTo(de.teamlapen.werewolves.api.entities.werewolf.TransformType)"(arg0: de.teamlapen.werewolves.api.entities.werewolf.TransformType_): number;
        ordinal(): number;
        wait(): void;
        wait(arg0: number): void;
        static valueOf(arg0: string): de.teamlapen.werewolves.api.entities.werewolf.TransformType;
        "compareTo(java.lang.Object)"(arg0: any): number;
        equals(arg0: any): boolean;
        get class(): typeof any
        get declaringClass(): typeof de.teamlapen.werewolves.api.entities.werewolf.TransformType
        static readonly TIME_LIMITED: (de.teamlapen.werewolves.api.entities.werewolf.TransformType) & (de.teamlapen.werewolves.api.entities.werewolf.TransformType);
        static readonly RAID: (de.teamlapen.werewolves.api.entities.werewolf.TransformType) & (de.teamlapen.werewolves.api.entities.werewolf.TransformType);
        static readonly FULL_MOON: (de.teamlapen.werewolves.api.entities.werewolf.TransformType) & (de.teamlapen.werewolves.api.entities.werewolf.TransformType);
    }
    type TransformType_ = "time_limited" | "full_moon" | TransformType | "raid";
}
...
declare namespace de.teamlapen.vampirism.mixin {
    interface VanillaBlockLootAccessor {
        getEXPLOSION_RESISTANT(): Internal.Set<Internal.Item>;
        get EXPLOSION_RESISTANT(): Internal.Set<Internal.Item>
    }
    type VanillaBlockLootAccessor_ = VanillaBlockLootAccessor;
}
