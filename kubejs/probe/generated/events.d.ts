...
tags(type: "worldgen/feature", handler: (event: TagEvent.Feature) => void): void
tags(type: "minecraft:worldgen/feature", handler: (event: TagEvent.Feature) => void): void
...
declare const BiomancyEvents: {
     ...
     * @at *server*
    */
onCradleSpawnMob(handler: (event: Internal.BiomancyKJSEvents$OnCradleSpawnMobEventKJS) => void):void,
    /**
     ...
     * @at *server*
    */
canCradleSpawnMob(handler: (event: Internal.BiomancyKJSEvents$CanCradleSpawnMobEventKJS) => void):void,
};
...
respawned(handler: (event: Internal.PlayerRespawnedEventJS) => void):void,
     ...
     * @cancellable
    */
manaRegen(handler: (event: Internal.ManaRegenEventJS) => void):void,
    /**
...
declare const AE2Events: {
    /**
     * @at *server*
    */
storageDelta(handler: (event: Internal.AppliedKJSEvents$StorageDeltaEventJS) => void):void,
    /**
     * @at *server*
    */
storageThreshold(handler: (event: Internal.AppliedKJSEvents$StorageThresholdEventJS) => void):void,
    /**
     * @at *server*
    */
craftingJobCompleted(handler: (event: Internal.AppliedKJSEvents$CraftingCpuEventJS) => void):void,
    /**
     * @at *server*
    */
craftingJobStopped(handler: (event: Internal.AppliedKJSEvents$CraftingCpuEventJS) => void):void,
    /**
     * @at *server*
    */
terminalOpened(handler: (event: Internal.AppliedKJSEvents$TerminalOpenedEventJS) => void):void,
    /**
     * @at *server*
    */
craftingJobStuck(handler: (event: Internal.AppliedKJSEvents$CraftingCpuEventJS) => void):void,
    /**
     * @at *server*
    */
craftingRequested(handler: (event: Internal.AppliedKJSEvents$CraftingRequestedEventJS) => void):void,
    /**
     * @at *server*
    */
craftingJobStarted(handler: (event: Internal.AppliedKJSEvents$CraftingCpuEventJS) => void):void,
    /**
     * @at *server*
    */
networkCreated(handler: (event: Internal.AppliedKJSEvents$GridLifecycleEventJS) => void):void,
    /**
     * @at *server*
    */
networkChanged(handler: (event: Internal.AppliedKJSEvents$GridChangedEventJS) => void):void,
    /**
     * @at *server*
    */
networkRemoved(handler: (event: Internal.AppliedKJSEvents$GridLifecycleEventJS) => void):void,
    /**
     * @at *server*
    */
networkPowerState(handler: (event: Internal.AppliedKJSEvents$GridPowerStateEventJS) => void):void,
    /**
     * @at *server*
    */
playerMilestone(handler: (event: Internal.AppliedKJSEvents$PlayerMilestoneEventJS) => void):void,
};
...
modifySpell(handler: (event: Internal.SpellModificationEventJS) => void):void,
     ...
     * @cancellable
    */
entitySpellPreCast(handler: (event: Internal.EntitySpellPreCastEventJS) => void):void,
    /**
     * @at *server*
     * 
     * @cancellable
...
spellOnCast(handler: (event: Internal.SpellOnCastEventJS) => void):void,
     ...
     * @at *server*
    */
entitySpellOnCast(handler: (event: Internal.EntitySpellCastEventJS) => void):void,
    /**
     * @at *server*
    */
changeMana(handler: (event: Internal.ChangeManaEventJS) => void):void,
...
registry(type: "fdlib:bedrock/animations", handler: (event: Registry.BedrockAnimations) => void):void,
registry(type: "fdlib:bedrock/models", handler: (event: Registry.BedrockModels) => void):void,
registry(type: "fdlib:boss_bars", handler: (event: Registry.BossBars) => void):void,
registry(type: "fdlib:configs", handler: (event: Registry.Configs) => void):void,
registry(type: "fdlib:model_attachment_type", handler: (event: Registry.ModelAttachmentType) => void):void,
registry(type: "fdlib:render_type", handler: (event: Registry.RenderType) => void):void,
registry(type: "fdlib:screen_effect", handler: (event: Registry.ScreenEffect) => void):void,
...
registry(type: "minecolonies:buildingextensions", handler: (event: Registry.Buildingextensions) => void):void,
registry(type: "minecolonies:buildings", handler: (event: Registry.Buildings) => void):void,
registry(type: "minecolonies:colonyeventdesctypes", handler: (event: Registry.Colonyeventdesctypes) => void):void,
registry(type: "minecolonies:colonyeventtypes", handler: (event: Registry.Colonyeventtypes) => void):void,
registry(type: "minecolonies:craftingtypes", handler: (event: Registry.Craftingtypes) => void):void,
registry(type: "minecolonies:equipmenttypes", handler: (event: Registry.Equipmenttypes) => void):void,
registry(type: "minecolonies:guardtypes", handler: (event: Registry.Guardtypes) => void):void,
registry(type: "minecolonies:happinessfactortypes", handler: (event: Registry.Happinessfactortypes) => void):void,
registry(type: "minecolonies:happinessfunction", handler: (event: Registry.Happinessfunction) => void):void,
registry(type: "minecolonies:interactionresponsehandlers", handler: (event: Registry.Interactionresponsehandlers) => void):void,
registry(type: "minecolonies:jobs", handler: (event: Registry.Jobs) => void):void,
registry(type: "minecolonies:questanswerresults", handler: (event: Registry.Questanswerresults) => void):void,
registry(type: "minecolonies:questobjectives", handler: (event: Registry.Questobjectives) => void):void,
registry(type: "minecolonies:questrewards", handler: (event: Registry.Questrewards) => void):void,
registry(type: "minecolonies:questtriggers", handler: (event: Registry.Questtriggers) => void):void,
registry(type: "minecolonies:recipetypeentries", handler: (event: Registry.Recipetypeentries) => void):void,
...
registry(type: "vampirism:entityactions", handler: (event: Registry.Entityactions) => void):void,
registry(type: "vampirism:miniontasks", handler: (event: Registry.Miniontasks) => void):void,
registry(type: "vampirism:oil", handler: (event: Registry.Oil) => void):void,
registry(type: "vampirism:refinement", handler: (event: Registry.Refinement) => void):void,
registry(type: "vampirism:refinement_set", handler: (event: Registry.RefinementSet) => void):void,
registry(type: "vampirism:skills", handler: (event: Registry.Skills) => void):void,
registry(type: "vampirism:task_requirement", handler: (event: Registry.TaskRequirement) => void):void,
...
registry(type: "hybrid-aquatic:sea_message", handler: (event: Registry.SeaMessage) => void):void,
